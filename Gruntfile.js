 ...
 * https://github.com/lintelio/lintel-contrib-buttons
 *
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          '<%= lintel.dist %>/buttons.css': 'sass/lintel-core-loader.scss'
        }
      }
    },
    ...
    cssmin: {
      ...
      dist: {
        src: '<%= lintel.dist %>/buttons.css',
        dest: '<%= lintel.dist %>/buttons.min.css'
      }
    },
    ...
    webshot: {
      xs: {
        options: {
          siteType: 'url',
          site: 'http://localhost:4554/buttons.html',
